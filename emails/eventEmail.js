...
<html lang="en">
  ...
  <body>
    ...
    <p>Hello ${name},</p>
    <p>We are delighted to inform you that your registration for the ${eventName} has been successfully confirmed.</p>
    ...
    <p class="b">Amount Due: ${due}</p>
    <p class="b">Payment Method: ${method}</p>
    <p class="b">Payment Due Date: ${dueDate}</p>
    <p>Please ensure that the payment is made by the due date to secure your enrollment in the Event.</p>
